...
public class Viper extends Kit{
    ...
    protected static Material[] _armor = new Material[]{Material.DIAMOND_BOOTS, Material.DIAMOND_LEGGINGS, Material.DIAMOND_CHESTPLATE, Material.DIAMOND_HELMET};
    protected static ItemStack _sword = new ItemBuilder(Material.IRON_SWORD, 1).toItemStack();
    protected static ItemStack _wand = new ItemBuilder(Material.SPIDER_EYE,1).toItemStack();

    public Viper(String name, Material icon, int price) {
        super(name,
